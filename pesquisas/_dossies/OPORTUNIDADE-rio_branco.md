# DOSSIÊ — AC · Rio Branco — praça de oportunidade (sem unidade)

**09/08/2026** · Mesmo processo das praças da rede, menos a parte que depende de unidade: aqui não existe unidade ainda.

> **AC · Rio Branco tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
- **Praça:** AC · Rio Branco
- **Município:** Rio Branco/AC · Vale do Acre
- **Unidade da rede:** nenhuma. Lista oficial e busca por nome, as duas, não acham unidade, conferido em duas fontes independentes.
- **Por que esta praça:** **AC · Rio Branco tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
| Fonte | O que rendeu |
|---|---:|
| Varredura da categoria (Google Places) | 120 clínicas |
...
|---|---:|
| Habitantes | **389.001** |
| Adultos de 30 a 45 | **88.887** |
| Jovens de 9 a 15 | 40.902 |
| Massa salarial por habitante/mês | R$ 2.777 |

O alvo adulto é **2,2× maior que o adolescente** — e decide sozinho. A proporção se repete nas sete praças medidas.
...
Varredura com os mesmos seis termos e três páginas das praças da rede: **120 clínicas**, 4.433 avaliações somadas, nota mediana 5.
...
| Abaixo de 100 | 109 |
| Líder | 619 |
| As 5 maiores concentram | 33% |
| De rede nacional | 4 |
| Sem site na ficha | 51% |
| Endereços com ficha duplicada | 22 |

### O líder e quem vem atrás

| Clínica | Avaliações | Nota |
|---|---:|---:|
| Ortho Life Consultório Odontológico | 619 | 4.9 |
| Laís Bittencourt | Endodontista | Tratamento de Canal | 235 | 5 |
| Mouzari Odonto Clinic & Mouzari Kids Odontopediatria | 226 | 5 |
| Clin Saúde | 199 | 5 |
| Studio RICCI Odontologia | 190 | 4.9 |
| Cliniodonto | Implantes Dentários Rio Branco-Dra Carla Santana CRO/AC 307 | 168 | 5 |
| Dra Yana Paiva - Clínica Odontológica em Rio Branco | 154 | 5 |
| Clinica Mediolins | 126 | 4.7 |
| TiraDentes Clínica | 124 | 5 |
| Odontologia de Sucesso - Dr. Maycon Perdome | Clínica Odontológica em Rio Branco | 114 | 5 |
...
- **Renda:** R$ 2.777 de massa salarial por habitante/mês.
- **Público-alvo:** 88.887 adultos de 30-45 e 40.902 jovens de 9-15.
- **Folga da categoria:** uma clínica forte para cada 389.001 habitantes.
...
Seis eixos comparados ao mesmo tempo (distância 0,30):

| Eixo | AC · Rio Branco | TO · Palmas | Razão |
|---|---:|---:|---:|
| habitantes | 389.001 | 328.499 | 1,18× |
| adultos de 30 a 45 | 88.887 | 78.759 | 1,13× |
| jovens de 9 a 15 | 40.902 | 32.089 | 1,27× |
| massa salarial por pessoa | 2.777 | 3.594 | 0,77× |
| clínicas fortes | 1 | 2 | 0,66× |
| volume do líder | 619 | 368 | 1,68× |
...
- jovens de 9 a 15: 1,3× maior aqui (40.902 contra 32.089)
- massa salarial por pessoa: 1,3× menor aqui (2.777 contra 3.594)
- clínicas fortes: 1,5× menor aqui (1 contra 2)
- volume do líder: 1,7× maior aqui (619 contra 368)
...
_Coletado até 09/08/2026. Radar de Oportunidade + o mesmo processo de `coleta/NOVA-PRACA.md` usado nas praças da rede, menos o que depende de unidade. Dados em `dados/oportunidade/rio_branco.json` e `dados/serie/`._
