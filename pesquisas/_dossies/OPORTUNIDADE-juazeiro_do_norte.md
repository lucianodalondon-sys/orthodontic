# DOSSIÊ — CE · Juazeiro do Norte — praça de oportunidade (sem unidade)

**09/08/2026** · Mesmo processo das praças da rede, menos a parte que depende de unidade: aqui não existe unidade ainda.

> **CE · Juazeiro do Norte tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.

---

## 1 · IDENTIDADE

- **Praça:** CE · Juazeiro do Norte
- **Município:** Juazeiro do Norte/CE · Sul Cearense
- **Unidade da rede:** nenhuma. Lista oficial e busca por nome, as duas, não acham unidade, conferido em duas fontes independentes.
- **Por que esta praça:** **CE · Juazeiro do Norte tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
| Fonte | O que rendeu |
|---|---:|
| Varredura da categoria (Google Places) | 124 clínicas |
...
|---|---:|
| Habitantes | **305.531** |
| Adultos de 30 a 45 | **69.988** |
| Jovens de 9 a 15 | 29.033 |
| Massa salarial por habitante/mês | R$ 1.761 |

O alvo adulto é **2,4× maior que o adolescente** — e decide sozinho. A proporção se repete nas sete praças medidas.
...
Varredura com os mesmos seis termos e três páginas das praças da rede: **124 clínicas**, 4.891 avaliações somadas, nota mediana 5.

| | |
|---|---:|
| Passam de 300 avaliações | **3** |
| Entre 100 e 299 | 10 |
| Abaixo de 100 | 111 |
| Líder | 356 |
| As 5 maiores concentram | 30% |
| De rede nacional | 4 |
| Sem site na ficha | 50% |
...
|---|---:|---:|
| Clínica Dentista Para Todos - Dentista Popular - Tratamento Acessível | 356 | 5 |
| Ortovital Dentistas Especializados | 326 | 4.7 |
| Sorrisokids family | 309 | 5 |
| Life Odonto | Clinica Odontológica | 276 | 4.9 |
| OdontoCompany Cariri | 225 | 4.6 |
| Dr. Absalão Maia - Consultório Odontológico | 213 | 5 |
| Consultório Odontológico - Dra Maria Regilânia Oliveira Almeida e Dr Matheus Oliveira Almeida | 198 | 5 |
| Odontopediatra Dr Adolfo Alencar | 184 | 5 |
| Dra AnaRuthe Grangeiro | 174 | 5 |
| Dra. Fabiana Batista - Dentista em Juazeiro do norte | 150 | 4.9 |
...
- **Renda:** R$ 1.761 de massa salarial por habitante/mês.
- **Público-alvo:** 69.988 adultos de 30-45 e 29.033 jovens de 9-15.
- **Folga da categoria:** uma clínica forte para cada 101.844 habitantes.
...
Seis eixos comparados ao mesmo tempo (distância 0,23):

| Eixo | CE · Juazeiro do Norte | TO · Palmas | Razão |
|---|---:|---:|---:|
| habitantes | 305.531 | 328.499 | 0,93× |
| adultos de 30 a 45 | 69.988 | 78.759 | 0,89× |
| jovens de 9 a 15 | 29.033 | 32.089 | 0,90× |
| massa salarial por pessoa | 1.761 | 3.594 | 0,49× |
| clínicas fortes | 3 | 2 | 1,53× |
| volume do líder | 356 | 368 | 0,97× |
...
- massa salarial por pessoa: 2,0× menor aqui (1.761 contra 3.594)
- clínicas fortes: 1,5× maior aqui (3 contra 2)
...
_Coletado até 09/08/2026. Radar de Oportunidade + o mesmo processo de `coleta/NOVA-PRACA.md` usado nas praças da rede, menos o que depende de unidade. Dados em `dados/oportunidade/juazeiro_do_norte.json` e `dados/serie/`._
