# DOSSIÊ — MA · Imperatriz — praça de oportunidade (sem unidade)

**09/08/2026** · Mesmo processo das praças da rede, menos a parte que depende de unidade: aqui não existe unidade ainda.

> **MA · Imperatriz tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
- **Praça:** MA · Imperatriz
- **Município:** Imperatriz/MA · Oeste Maranhense
- **Unidade da rede:** nenhuma. Lista oficial e busca por nome, as duas, não acham unidade, conferido em duas fontes independentes.
- **Por que esta praça:** **MA · Imperatriz tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
| Fonte | O que rendeu |
|---|---:|
| Varredura da categoria (Google Places) | 117 clínicas |
...
|---|---:|
| Habitantes | **285.806** |
| Adultos de 30 a 45 | **67.291** |
| Jovens de 9 a 15 | 28.561 |
| Massa salarial por habitante/mês | R$ 2.763 |
...
Varredura com os mesmos seis termos e três páginas das praças da rede: **117 clínicas**, 3.219 avaliações somadas, nota mediana 5.

| | |
|---|---:|
| Passam de 300 avaliações | **0** |
| Entre 100 e 299 | 8 |
| Abaixo de 100 | 109 |
| Líder | 291 |
| As 5 maiores concentram | 30% |
| De rede nacional | 4 |
| Sem site na ficha | 45% |
| Endereços com ficha duplicada | 21 |

### O líder e quem vem atrás

| Clínica | Avaliações | Nota |
|---|---:|---:|
| Gonçalves Odontologia | Dentista em Imperatriz - Especialista em Implantes, Aparelhos, Clareamento e Facetas Dentais | 291 | 5 |
| HappyClin | 223 | 4.9 |
| Smile Odontologia | 165 | 5 |
| OdontoMob | Dentista em Imperatriz | 149 | 4.9 |
| Dr Henrique | Dr Shaymon - Odontologia Avançada | 142 | 5 |
| Unique Smile Clin - Clínica Odontológica em Imperatriz | 133 | 4.9 |
| Consultório odontológico Dra Laís Santos | 114 | 4.9 |
| Clínica Mãe | 110 | 4.3 |
| Instituto Implamar | 96 | 4.8 |
| Conceitos odontologia | 96 | 5 |
...
- **Renda:** R$ 2.763 de massa salarial por habitante/mês.
- **Público-alvo:** 67.291 adultos de 30-45 e 28.561 jovens de 9-15.
- **Folga da categoria:** nenhuma clínica passa de 300 avaliações.
...
Seis eixos comparados ao mesmo tempo (distância 0,43):

| Eixo | MA · Imperatriz | TO · Palmas | Razão |
|---|---:|---:|---:|
| habitantes | 285.806 | 328.499 | 0,87× |
| adultos de 30 a 45 | 67.291 | 78.759 | 0,85× |
| jovens de 9 a 15 | 28.561 | 32.089 | 0,89× |
| massa salarial por pessoa | 2.763 | 3.594 | 0,77× |
| clínicas fortes | 0 | 2 | 0,20× |
| volume do líder | 291 | 368 | 0,79× |
...
- massa salarial por pessoa: 1,3× menor aqui (2.763 contra 3.594)
- clínicas fortes: 5,0× menor aqui (0 contra 2)
- volume do líder: 1,3× menor aqui (291 contra 368)
...
_Coletado até 09/08/2026. Radar de Oportunidade + o mesmo processo de `coleta/NOVA-PRACA.md` usado nas praças da rede, menos o que depende de unidade. Dados em `dados/oportunidade/imperatriz.json` e `dados/serie/`._
