# DOSSIÊ — PA · Marabá — praça de oportunidade (sem unidade)

**09/08/2026** · Mesmo processo das praças da rede, menos a parte que depende de unidade: aqui não existe unidade ainda.

> **PA · Marabá tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
- **Praça:** PA · Marabá
- **Município:** Marabá/PA · Sudeste Paraense
- **Unidade da rede:** nenhuma. Lista oficial e busca por nome, as duas, não acham unidade, conferido em duas fontes independentes.
- **Por que esta praça:** **PA · Marabá tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
| Fonte | O que rendeu |
|---|---:|
| Varredura da categoria (Google Places) | 92 clínicas |
...
|---|---:|
| Habitantes | **290.975** |
| Adultos de 30 a 45 | **65.866** |
| Jovens de 9 a 15 | 32.432 |
| Massa salarial por habitante/mês | R$ 2.792 |
...
Varredura com os mesmos seis termos e três páginas das praças da rede: **92 clínicas**, 3.017 avaliações somadas, nota mediana 5.
...
| Abaixo de 100 | 87 |
| Líder | 583 |
| As 5 maiores concentram | 51% |
| De rede nacional | 1 |
| Sem site na ficha | 47% |
| Endereços com ficha duplicada | 14 |

### O líder e quem vem atrás

| Clínica | Avaliações | Nota |
|---|---:|---:|
| Odonto Excellence - Marabá | 583 | 5 |
| Instituto Barros e Bosi Odontologia | Marabá | 342 | 5 |
| Clínica Odonto Minas Marabá | 309 | 4.9 |
| Ryso Odonto Premium | 177 | 5 |
| Clínica Odontológica Orto Prime Estética | 132 | 4.9 |
| RX digital - Radiologia Odontológica - Unidade Novo Horizonte | 97 | 5 |
| Maforte Odontologia| Marabá | 95 | 5 |
| DV ODONTO - Dentista, implante dentário, prótese protocolo, lentes dentárias, botox, preenchimento, harmonização facial | 94 | 5 |
| Clinica Nosso Dentista Cidade Nova | 77 | 3.9 |
| EB ODONTOLOGIA - MARABÁ-PA | 71 | 4.6 |
...
- **Renda:** R$ 2.792 de massa salarial por habitante/mês.
- **Público-alvo:** 65.866 adultos de 30-45 e 32.432 jovens de 9-15.
- **Folga da categoria:** uma clínica forte para cada 96.992 habitantes.
...
| Eixo | PA · Marabá | TO · Palmas | Razão |
|---|---:|---:|---:|
| habitantes | 290.975 | 328.499 | 0,89× |
| adultos de 30 a 45 | 65.866 | 78.759 | 0,84× |
| jovens de 9 a 15 | 32.432 | 32.089 | 1,01× |
| massa salarial por pessoa | 2.792 | 3.594 | 0,78× |
| clínicas fortes | 4 | 2 | 1,99× |
| volume do líder | 583 | 368 | 1,58× |
...
- massa salarial por pessoa: 1,3× menor aqui (2.792 contra 3.594)
- clínicas fortes: 2,0× maior aqui (4 contra 2)
- volume do líder: 1,6× maior aqui (583 contra 368)
...
_Coletado até 09/08/2026. Radar de Oportunidade + o mesmo processo de `coleta/NOVA-PRACA.md` usado nas praças da rede, menos o que depende de unidade. Dados em `dados/oportunidade/maraba.json` e `dados/serie/`._
