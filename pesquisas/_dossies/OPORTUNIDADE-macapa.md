# DOSSIÊ — AP · Macapá — praça de oportunidade (sem unidade)

**09/08/2026** · Mesmo processo das praças da rede, menos a parte que depende de unidade: aqui não existe unidade ainda.

> **AP · Macapá tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
- **Praça:** AP · Macapá
- **Município:** Macapá/AP · Sul do Amapá
- **Unidade da rede:** nenhuma. Lista oficial e busca por nome, as duas, não acham unidade, conferido em duas fontes independentes.
- **Por que esta praça:** **AP · Macapá tem o perfil de TO · Palmas.** Lá a unidade OrthoDontic tem 304 avaliações, nota 5,0 e faz 14,0 avaliações por mês **há 11 meses seguidos**, 3ª em ritmo entre as 14 clínicas acompanhadas na praça — é operação, não campanha, e é o tipo de resultado que se copia.
...
| Fonte | O que rendeu |
|---|---:|
| Varredura da categoria (Google Places) | 133 clínicas |
...
|---|---:|
| Habitantes | **489.676** |
| Adultos de 30 a 45 | **104.811** |
| Jovens de 9 a 15 | 52.890 |
| Massa salarial por habitante/mês | R$ 3.143 |

O alvo adulto é **2,0× maior que o adolescente** — e decide sozinho. A proporção se repete nas sete praças medidas.
...
Varredura com os mesmos seis termos e três páginas das praças da rede: **133 clínicas**, 4.295 avaliações somadas, nota mediana 5.

| | |
|---|---:|
| Passam de 300 avaliações | **1** |
| Entre 100 e 299 | 10 |
| Abaixo de 100 | 122 |
| Líder | 427 |
| As 5 maiores concentram | 28% |
| De rede nacional | 8 |
| Sem site na ficha | 56% |
| Endereços com ficha duplicada | 26 |

### O líder e quem vem atrás

| Clínica | Avaliações | Nota |
|---|---:|---:|
| Vamos Sorrir - Odontologia, Dentista em Macapá | 427 | 4.9 |
| Odonto Advance - Dr Decio Bisognin e Equipe | 249 | 4.9 |
| Clínica Odontológica DENTEBRAS Macapá Centro | 226 | 5 |
| AmorSaúde Macapá | 166 | 3.6 |
| Clinica Perfetha Odontologia Especializada | 150 | 5 |
| Clínica Odontológica DENTEBRAS Macapá Buritizal | 149 | 4.8 |
| OdontoImperium Odontologia Integrada | 143 | 5 |
| Dra Adriana Gato Implantes | 135 | 5 |
| Happy - odontopediatria encantada | 128 | 5 |
| Clínica Odontológica Centerclin | 105 | 4.8 |
...
- **Renda:** R$ 3.143 de massa salarial por habitante/mês.
- **Público-alvo:** 104.811 adultos de 30-45 e 52.890 jovens de 9-15.
- **Folga da categoria:** uma clínica forte para cada 489.676 habitantes.
...
| Eixo | AP · Macapá | TO · Palmas | Razão |
|---|---:|---:|---:|
| habitantes | 489.676 | 328.499 | 1,49× |
| adultos de 30 a 45 | 104.811 | 78.759 | 1,33× |
| jovens de 9 a 15 | 52.890 | 32.089 | 1,65× |
| massa salarial por pessoa | 3.143 | 3.594 | 0,87× |
| clínicas fortes | 1 | 2 | 0,61× |
| volume do líder | 427 | 368 | 1,16× |

**Uma gêmea é um caso; três são uma faixa.**

| Ritmo/mês | Meses | Selo | Unidade | Praça | De onde vem |
|---:|---:|---|---|---|---|
| 0,0 | 1 | parada | OrthoDontic Feira de Santana | BA · Feira de Santana | ⚠ o contador CAIU 3 avaliações em 23 dias — avaliação removida ou ficha mexida |
...
A faixa vai de **0,0** a **14,0 por mês** em praças de perfil parecido. **A diferença entre as pontas não é a cidade — é a operação.**

**Onde NÃO bate** — e isto vale mais que onde bate:

- habitantes: 1,5× maior aqui (489.676 contra 328.499)
- adultos de 30 a 45: 1,3× maior aqui (104.811 contra 78.759)
- jovens de 9 a 15: 1,6× maior aqui (52.890 contra 32.089)
- clínicas fortes: 1,6× menor aqui (1 contra 2)
...
_Coletado até 09/08/2026. Radar de Oportunidade + o mesmo processo de `coleta/NOVA-PRACA.md` usado nas praças da rede, menos o que depende de unidade. Dados em `dados/oportunidade/macapa.json` e `dados/serie/`._
