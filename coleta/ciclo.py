...
COLETORES = {
 ...
 "reclame_aqui":   dict(freq="mensal", status="construir", custo="~US$1-3/praça",
   da="volume de reclamação, índice de resposta, tempo, solução — por UNIDADE"),
 "google_ads":     dict(freq="semanal", status="construir", custo="a medir",
   da="quem compra a BUSCA — só olhamos o Meta até hoje"),
 ...
 "instagram":      dict(freq="mensal", status="construir", custo="~US$0,40/praça",
